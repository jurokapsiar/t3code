...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.opencodeListSessions]: AuthOrchestrationReadScope,
  [WS_METHODS.opencodeGetSessionMessages]: AuthOrchestrationReadScope,
  [WS_METHODS.opencodeReconcileThread]: AuthOrchestrationReadScope,
