 ...
 *
 * v6 adds OpenCode to {@link UsageProviderKind}; v5 Claude/Codex/Grok buckets
...
export const UsageSummaryInput = Schema.Struct({
  ...
  /** Reconcile OpenCode exports only for the Cost view. */
  includeOpenCode: Schema.optional(Schema.Boolean),
});
